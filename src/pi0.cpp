				...
				double &e_phi,int &tcheck) //return electron (angle already known by Q2)
{
	...
	double umin = UfromCosTheta(1.0, W, Q2); //forwards limit
	double umax = UfromCosTheta(-1.0, W, Q2); //backwards limit
	...
	double fsphoton_pz_rot = fsphoton_ptot*cos(theta_scatter);
	//final-state proton:
