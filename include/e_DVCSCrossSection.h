...
#ifndef e_DVCSCROSSSECTION_H
#define e_DVCSCROSSSECTION_H


#include "photonNucleusCrossSection.h"


class e_DVCSCrossSection : public photonNucleusCrossSection {

public:

	e_DVCSCrossSection(const inputParameters& input, const beamBeamSystem&  bbsystem);
	~e_DVCSCrossSection();
